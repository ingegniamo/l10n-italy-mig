    ...
    def button_validate(self):
        ...
        if delivery_note_to_create and not self.delivery_note_id:
            ...
            if self.mapped('sale_id'):
                 self.mapped('sale_id')._assign_delivery_notes_invoices(self.mapped('sale_id').invoice_ids)
        return res
